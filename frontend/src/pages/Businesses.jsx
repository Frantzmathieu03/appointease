      ...
      <div className='max-w-6xl mx-auto px-6 py-10'>
        ...
        {loading ? (
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {businesses.map(b => (
              <div key={b._id} className='bg-white rounded-2xl border border-slate-100 p-6 hover:shadow-md transition cursor-pointer' onClick={() => navigate('/book/' + b.name.toLowerCase().replace(/s+/g, '-'))}>
